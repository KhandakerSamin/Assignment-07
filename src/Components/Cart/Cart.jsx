    ...
    return (
        <div className='w-72 h-min-[100px]'>
            <div className='bg-white ml-10 min-h-[300px] rounded-xl w-[300px] px-8'>
                <h1 className='border-b-2 font-bold text-[#2F80ED] py-4 text-left'>Credit Hour Remaining {remaining} hr</h1>
                <h2 className='font-bold text-left py-4  border-b-2'>Course Name</h2>
                <div className='min-h-[120px]'>
                    {selectedCourse.map((course) => (
                        <li className='list-decimal text-left' key={course.id}>{course.course_name}</li>
                    ))}
                </div>
